...
export const Template = ({
  ...
  <div role="alert" class="${type}">
    ...
    <div>
      ${heading ? `<div class="gds-alert-ribbon__heading">${heading}</div>` : ''}
      <p>
        ${content}
        ${link ? `<a href="#">${link}</a>.` : ''}
      </p>
    ...
    ${
      button || primaryButton
        ? `<div class="gds-alert-ribbon__footer">
...
<Canvas>
  <div>
    <div class="gds-alert-ribbon">
      <p>Neutral (no class)</p>
    </div>
  </div>
  <div class="gds-alert-ribbon success">
    <div>
      <p>Success</p>
    </div>
  </div>
  <div class="gds-alert-ribbon warning">
    <div>
      <p>Warning</p>
    </div>
  </div>
  <div class="gds-alert-ribbon danger">
    <div>
      <p>Danger</p>
    </div>
  </div>
...
The outer wrapper element should always be a `<div>` with either the `role="alert"` or the `class="gds-alert-ribbon"`.

Alert Ribbon can contain the following elements:

**Content**<br/>
Content should be placed inside `<div class="gds-alert-ribbon__content">...</div>`.

**Heading** (optional)<br/>
The heading is the first element within the content element and could be a `<h1>, <h2>, <h3>, <h4>, <h5>` or a `<div class="gds-alert-ribbon__heading">...</div>` depending if the heading should be included in the document heading hirarchy. Additional text should be placed within a `<p>`. It can contain links like `<a>` elements and plain text.

**Close button** (optional)<br/>
`<button class="close">...</button>` if the alert is dismissible.

**Footer** (optional)<br/>
If the alert has actions like buttons or links they should be placed inside a `<div class="gds-alert-ribbon__footer">...</footer>`.
...
<Canvas>
  <div>
    <div class="gds-alert-ribbon">
      ...
      <div class="gds-alert-ribbon__content">
        <div class="gds-alert-ribbon__heading">Can contain a heading.</div>
        <p>
